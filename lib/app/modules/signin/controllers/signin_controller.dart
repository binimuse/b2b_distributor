...
class SigninController extends GetxController {
  ...
  final List<String> dropdownValues = ["distributor", "delivery"].obs;
  var dropdownValue = 'Distributor'.obs;
  final count = 0.obs;
  @override
  void onInit() {
  ...
  void signIn() async {
    ...
    if (dropdownValue.value == "Distributor") {
      Navigator.of(Get.context!).pop();
      Get.offNamed(Routes.HOME);
    } else if (dropdownValue.value == "Delivery") {
      Navigator.of(Get.context!).pop();
